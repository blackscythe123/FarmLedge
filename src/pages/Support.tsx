      ...
      <main className="container mx-auto px-4 py-28 space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="p-6 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Report issues or file formal complaints.</p>
            <a href="mailto:grievance.agri@odisha.gov.in"><Button size="sm" variant="outline">File Grievance</Button></a>
          </Card>
          <Card className="p-6 space-y-2">
